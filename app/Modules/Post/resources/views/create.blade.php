    ...
    <div class="card-body">
      <div class="row">
        <div class="row col-md-12">
          <div class="col-md-6">
            <input class="form-control" type="text" name="title" placeholder="Title" required maxlength="255">
          </div>
          <div class="col-md-6">
  ...
  if (api_auth_token!=null) {
    ...
    $('form').on('submit', function(e){
      ...
      $.ajax({
        ...
        processData: false,
        contentType: false,
        url : '{{url(config('variables.api_domain'))}}/post/store',
        data : data,
    ...
    $.ajax({
        ...
        success: function(data){
          $.each(data.data, function(i, e) {
            $('#category').append($('<option/>').attr('value', e.id).text(e.title));
          });
        }
    });
  }
